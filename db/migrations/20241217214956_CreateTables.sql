...
CREATE TABLE Sponsorship(
    ...
    FOREIGN KEY (SponsorId) REFERENCES Company(Id),
);
...
CREATE TABLE Person(
    Id INTEGER PRIMARY KEY,
    TypeId INTEGER,
    FOREIGN KEY (TypeId) REFERENCES PersonType(Id),
...
CREATE TABLE WorldEvent(
    ...
    FOREIGN KEY (TypeId) REFERENCES WorldEventType(Id),
    Body JSONB,
    TimelineDay INTEGER,
);
...
CREATE TABLE Fight(
    ...
    Fighter0Id INTEGER NOT NULL,
    FOREIGN KEY (Fighter0Id) REFERENCES Person(Id),
    Fighter1Id INTEGER NOT NULL,
    FOREIGN KEY (Fighter1Id) REFERENCES Person(Id),
    RefereeId INTEGER NOT NULL,
    FOREIGN KEY (RefereeId) REFERENCES Person(Id),
    ...
    -- If null: still going.
    EndTypeId INTEGER,
    FOREIGN KEY (EndTypeId) REFERENCES FightEndType(Id),
);
